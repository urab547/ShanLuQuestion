export const DIALOGUES = {
  ...
  dlg_prayer_flags: {
    ...
    lines: [
      '五色经幡在风中猎猎作响。',
      '听村里人说，五种颜色各有所属——天、云、火、水、土，各归其位，祈福才灵。',
      '至于哪种颜色属什么、该排在哪里……或许得问问念经的人。',
    ],
  },
  dlg_stone_well: {
    id: 'dlg_stone_well',
  ...
  // ===== 经堂开门剧情（白玛/卓玛带路开门，Scene.jsx 出口逻辑引用） =====
  dlg_temple_opened_by_baima: {
    id: 'dlg_temple_opened_by_baima',
    title: '白玛',
    lines: [
      '白玛不知何时已站在你身后。她看了一眼那扇门，从氆氇下面取出一把小小的铜钥匙，攥在掌心。',
      { text: '「这把钥匙，是他交给我保管的。……因为他知道，我不会随便拿去开门。」', isKeyLine: true },
      '她走到门前，回头看了你一眼：',
  ...
  dlg_old_wood_box: {
    ...
    title: '旧木盒',
    lines: [
      '床边放着一只旧木盒，盒面的漆已经斑驳，铜扣却被摩挲得发亮。',
      '你轻轻打开——里面是一张黑白照片，和一小块叠得整整齐齐的白色氆氇。',
      '照片上是一个年轻的藏族女人，站在经堂门口，笑着。',
      '照片的边角磨圆了——这张照片被人拿出来看过很多很多次。',
    ],
  },
  dlg_danzeng_photo_reveal: {
    ...
    title: '旦增',
    lines: [
      '旦增不知何时已站在卧室门口。他看着你手里的木盒，没有说话。',
      '许久，他走过来，从你手中接过照片，用袖口轻轻拂过相纸。',
      '你第一次看到他的表情不是"沉默"——是"记得"。',
      { text: '「……她。」', isKeyLine: true },
      { text: '「她走了以后，我画了四十九天。这间屋子里所有的东西，都是那四十九天剩下来的。」', isKeyLine: true },
      '他把照片放回盒中，合上盖子，动作很轻，像怕吵醒什么。',
    ],
  },
...
//   - 退出按钮 → 触发 dlg_ch1_s1_exit → 返回地图
  ...
  dlg_ch1_s1_entry: {
    ...
    lines: [
      '清晨。风从山口灌进来，带着经幡布料低沉的响声，和远处几声奶牛叫。',
  ...
  dlg_danzeng_r1_open: {
    ...
    // 选项支持对象格式：{ text, next, trustDelta, npcId }
    // 禁忌选项 → 跳转 dlg_danzeng_scene_end 并扣信任；安全选项 → 默认推进 nextDialogueId
    playerOptions: [
      { text: '那幅画……我想多了解一些。', next: 'dlg_danzeng_scene_end', trustDelta: -5, npcId: 'danzeng' },
      { text: '那块白色的布……是什么？' },
      { text: '……我只是来看看。' },
      { text: '（沉默）' },
    ],
  ...
  dlg_danzeng_r2: {
    ...
    playerOptions: [
      { text: '她跟我说了残页的事。' },
      { text: '那幅画到底在哪？', next: 'dlg_danzeng_scene_end', trustDelta: -5, npcId: 'danzeng' },
      { text: '没说什么特别的。' },
      { text: '你为什么十二年不说话？', next: 'dlg_danzeng_scene_end', trustDelta: -5, npcId: 'danzeng' },
    ],
  ...
  dlg_danzeng_scene_end: {
    ...
    lines: [
      '旦增的手停了一下。',
      { text: '「……你走吧。今天。」', isKeyLine: true },
      '旦增重新低头做事，不再回应。藏獒抬起头，盯着你。',
      '（他不喜欢被直接追问。也许……先听，再问。改天可以再来试试。）',
    ],
    // 未通过测试，不获得「明天再来」；玩家可再次点击旦增重新尝试场景B
  },
  ...
  dlg_danzeng_ch4_truth_end: {
    ...
    title: '旦增',
    lines: [
      '旦增转身，慢慢走出经堂。他的背影在门口的光里停了一瞬，然后消失了。',
    ],
    nextDialogueId: 'dlg_baima_ch4_memory_intro',  // 链入场景D-2（白玛回忆）
  },
  ...
  dlg_baima_ch4_memory_intro: {
    ...
    title: '白玛',
    lines: [
      '白玛从经堂外的转角处出现——她没有走进经堂，只是站在门外。',
      { text: '「他不会告诉你的。……有些事，他十二年没对人说过了。」', isKeyLine: true },
      '白玛停顿了一会儿：',
      { text: '「你来。」', isKeyLine: true },
      '她带着你走到她念经的角落——远离经堂，旦增听不到的地方。',
    ],
    nextDialogueId: 'dlg_baima_ch4_memory_1',
  },
  ...
  dlg_baima_ch4_memory_1: {
    ...
    lines: [
      ...
      '年幼的格桑站在门口，不敢进来。白玛在屋外念经。',
      '你的祖父沈默之坐在旦增旁边，一只手搭在他肩上。',
      { text: '「阿姐走的那年，格桑还小。她病了三个月，旦增每天画一幅唐卡，说要把她画进度母的眷属里。……但阿姐说，不用画了。她说，她不怕死。」', isKeyLine: true },
    ],
    nextDialogueId: 'dlg_baima_ch4_memory_2',
  },
  ...
  dlg_baima_ch4_memory_2: {
    ...
    nextDialogueId: 'dlg_baima_ch4_memory_3',
  },
  ...
  dlg_baima_ch4_memory_3: {
    ...
    lines: [
      '——天葬后的第七天，经堂——',
      '旦增坐在经堂里，面前是一块空白画布。',
      '他拿起妻子留下的白色氆氇，用刀裁下一小块，放入研钵，慢慢研磨。',
      '你的祖父坐在他旁边，拿着笔记本，记录每一步。',
      '最后一天，他画度母的左眼——停了很久。然后闭了一下眼，睁开，一笔画成。他没有看任何参照。',
      { text: '「他画了四十九天。你祖父一步都没离开过。……没有人教他画那只眼睛。他自己知道该画什么。」', isKeyLine: true },
    ],
    nextDialogueId: 'dlg_baima_ch4_memory_4',
  },
  ...
  dlg_baima_ch4_memory_4: {
    ...
    nextDialogueId: 'dlg_baima_ch4_memory_close',
  },
  ...
  dlg_baima_ch4_memory_close: {
    ...
    nextDialogueId: 'dlg_ch5_transition',  // 链入第五章收束
  },
  ...
  dlg_ch5_transition: {
    ...
    // 链尾：关闭时由 Scene.jsx 触发留白结局演出（EndingSequence 组件）
    // 原 dlg_end_cinematic_phase1~5 为镜头/音效指令稿，不直接作为对话展示
  },
